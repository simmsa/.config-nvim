...
" My stuff
syn match org_5_header "\_^\*\{5}\s"
syn match org_4_header "\_^\*\{4}\s"
syn match org_3_header "\_^\*\{3}\s"
syn match org_2_header "\_^\*\{2}\s"
syn match org_1_header "\_^\*\{1}\s" contained

syn match org_todo "TODO"
syn match org_underway "UNDERWAY"
syn match org_done "DONE"
syn match org_1_todo "TODO" contained
syn match org_1_underway "UNDERWAY" contained
syn match org_1_done "DONE" contained

syn match org_time "\s\[.*\]\_$"
syn match org_time_1_header "\s\[.*\]\_$" contained

syn match org_1_line "\_^\*\{1}\s[A-Z*].*\["hs=s+2,he=e-2 contains=org_1_header,org_time_1_header,org_1_todo,org_1_underway,org_1_done
