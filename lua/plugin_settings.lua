...
local function display_paste()
    -- local paste_raw = vim.api.nvim_command("echo &paste")
    local paste_mode_active = vim.o.paste

    if paste_mode_active then
        return "PASTE"
    else
        return "NOPASTE"
    end
...
require("lualine").setup({
    ...
    sections = {
        lualine_a = { "mode", "searchcount", display_paste },
...
-- 	opts = {
-- 		lspFeatures = {
-- 			languages = { "r", "python", "bash", "html", "dot" },
-- 		},
-- 	},
-- })
...
--             normal = "cc",               -- Normal mode keymap for toggling Claude Code, false to disable
